...
<div class="h-full ml-14 mt-14 mb-10 md:ml-64">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-1 p-4 gap-1">
      <div class="bg-blue-500 dark:bg-gray-800 shadow-lg rounded-md flex items-center justify-between p-3 border-b-4 border-blue-600 dark:border-gray-600 text-white font-medium group">
        ...
        <a href="{{route('productos.create')}}" type="submit" class="bg-white text-blue-800 font-semibold mb-2 ml-4 py-2 px-4 border border-blue-400 rounded shadow"> Ingresar Producto</a>
        </div>
      </div>
    </div>
    <!-- ./Statistics Cards -->
