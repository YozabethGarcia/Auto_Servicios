                ...
                <div class="py-6 w-100">
                    <div class="w-50 py-4  sm:px-6 lg:px-8" style="float: left">
                        ...
                        <div class="mt-1">
                            ...
                            type="number" value="{{old('codigo',$producto->barcode)}}">
                            <br>     
                        ...
                        <div class="mt-1">
                            ...
                            cols="50" rows="3">{{old('descripcion',$producto->descripcion)}}</textarea>                             
                        </div>
                        <br>
                        ...
                        <div class="mt-1">
                            ...
                            type="number" value="{{old('valor',$producto->stock)}}">
                            <br>                            
                        ...
                        <div class="mt-1">
                            ...
                            type="number" value="{{old('valormin',$producto->min_stock)}}">
                            <br>                            
                        ...
                        <div class="mt-1">
                            ...
                            type="number" value="{{old('valormax',$producto->max_stock)}}">
                            <br>                            
                        ...
                        <div class="mt-1">
                            ...
                            type="text" value="{{old('ubicacion',$producto->ubicacion)}}">
                            <br>                            
                        ...
                        <div class="mb-8 mt-1">
                            ...
                            <select name="tproducto" value="{{$producto->tipo_producto_id}}"
                                ...
                                <option value='{{ $tipo->id }}' <?php if($tipo->id == old('tproducto', $producto->tipo_producto_id)) echo 'selected' ?>> {{ $tipo->tipo }}</option>
                                @endforeach
                            </select> 
